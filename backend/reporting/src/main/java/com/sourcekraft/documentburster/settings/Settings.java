...
import com.sourcekraft.documentburster.settings.model.Capabilities;
import com.sourcekraft.documentburster.settings.model.DocumentBursterSettings;
import com.sourcekraft.documentburster.settings.model.EmailRfc2822Validator;
import com.sourcekraft.documentburster.settings.model.EmailSettings;
import com.sourcekraft.documentburster.settings.model.ReportSettings;
import com.sourcekraft.documentburster.settings.model.ReportingSettings;
import com.sourcekraft.documentburster.settings.model.RetryPolicy;
import com.sourcekraft.documentburster.settings.model.SendFiles;
...
public class Settings extends DumpToString {
	...
	public void loadSettings(String configFilePath) throws Exception {
		...
		docSettings = (DocumentBursterSettings) u.unmarshal(new File(configFilePath));
		...
		if (!Objects.isNull(docSettings.settings.capabilities)
			...
			this.loadReportingSettings(reportingConfigFilePath);
		}
	...
	public void loadReportingSettings(String reportingConfigFilePath) throws Exception {
		JAXBContext jcr = JAXBContext.newInstance(ReportingSettings.class);

		Unmarshaller ur = jcr.createUnmarshaller();

		reportingSettings = (ReportingSettings) ur.unmarshal(new File(reportingConfigFilePath));
	}
	...
	public ReportSettings.DataSource getReportDataSource() {
		return reportingSettings.settings.datasource;
	}

	public ReportSettings.Template getReportTemplate() {
		return reportingSettings.settings.template;
	}
	...
	public int getTestEmailServerPort() {
	...
	public void setTestEmailServerPort(int port) {
