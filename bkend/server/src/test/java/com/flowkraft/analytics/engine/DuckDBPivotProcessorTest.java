package com.flowkraft.analytics.engine;
...
public class DuckDBPivotProcessorTest {
	...
	public void testNullRequestThrowsException() {
		assertThrows(IllegalArgumentException.class, () -> processor.generateSQL(null));
	}
	...
	public void testEmptyTableNameThrowsException() {
		...
		assertThrows(IllegalArgumentException.class, () -> processor.generateSQL(request));
	}
}
