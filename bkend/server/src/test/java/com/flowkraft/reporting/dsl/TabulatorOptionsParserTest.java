...
public class TabulatorOptionsParserTest {
	...
	public void testVirtualDomHorizontal() throws Exception {
		...
		assertNull(opts.get("columns"), "columns should not be set when autoColumns is true");
	}
	...
	public void testFitToData() throws Exception {
		...
		assertEquals("311px", opts.get("height"));
		assertNull(opts.get("layout"), "layout should not be set (fitData is the default)");
	...
	public void testResponsiveLayoutCollapsedList() throws Exception {
		...
		assertNotNull(rowHeader, "rowHeader should be present for collapse toggle");
	...
	public void testLocalization() throws Exception {
		...
		assertNotNull(langs, "langs should be present");
		assertTrue(langs.containsKey("fr-fr"), "Should contain fr-fr locale");
		assertTrue(langs.containsKey("de-de"), "Should contain de-de locale");
