...
public final class EmailBoxed2columnResponsive {

    private EmailBoxed2columnResponsive() {}

    public static PromptDefinition create() {
        return new PromptDefinition(
            "EMAIL_BOXED_2COLUMN_RESPONSIVE",
            "A responsive template with a boxed layout and a two-column structure",
            "A responsive template with a boxed layout and a two-column structure",
            List.of("email-template-responsive", "two-column"),
