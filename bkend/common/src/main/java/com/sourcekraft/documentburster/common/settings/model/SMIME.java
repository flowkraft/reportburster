...
public class SMIME extends DumpToString {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8486674104004880653L;

	public String signingkeystore;
	public String signingkeystorepassword;
