...
use ReportBurster_Integration\WPBones\Foundation\Plugin;
...
|
*/
if (class_exists('\ReportBurster_Integration\WPBones\Foundation\Plugin')) {
    $plugin = new Plugin(
        realpath(__DIR__ . '/../')
    );
     ...
     */
    do_action('reportburster-integration_loaded');
