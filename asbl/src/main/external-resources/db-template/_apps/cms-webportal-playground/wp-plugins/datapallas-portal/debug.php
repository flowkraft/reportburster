...
$service_provider_exists = class_exists('DataPallas_Portal\WPBones\Support\ServiceProvider');
rb_debug_log('ServiceProvider class exists: ' . ($service_provider_exists ? 'YES' : 'NO'));

// Test if AppServiceProvider class exists
$app_provider_exists = class_exists('DataPallas_Portal\Providers\AppServiceProvider');
