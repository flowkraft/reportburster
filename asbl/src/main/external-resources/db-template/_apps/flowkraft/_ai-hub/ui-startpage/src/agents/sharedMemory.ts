...
function getSkill(name: string): { name: string; description: string } {
    const skillDescriptions: Record<string, string> = {
        ...
        'datapallas-ui-and-docs-navigation': 'Complete map of the DataPallas application UI and documentation site. Use when a user asks "where do I find X?", "how do I get to Y?", "where is the docs page for Z?", or needs help navigating menus or finding the right documentation. Covers: top navigation bar (Processing, Configuration, Help & Support), left sidebar menus for each area, what each screen does, and the full documentation site map with verified URLs for every topic. Key docs: https://www.reportburster.com/docs',
