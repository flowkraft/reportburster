        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-card border border-border rounded-lg p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Data Modeler & Reporting Advisor</p>
            </div>
            <div className="bg-card border border-border rounded-lg p-6 text-center">
              <h3 className="font-semibold text-foreground mb-2">Hephaestus</h3>
              <p className="text-sm text-muted-foreground">Backend Jobs/ETL/Automation Advisor</p>
            </div>
            <div className="bg-card border border-border rounded-lg p-6 text-center">
              <h3 className="font-semibold text-foreground mb-2">Hermes</h3>
              <p className="text-sm text-muted-foreground">UI Frend & Self-Service Advisor</p>
            </div>
          </div>
