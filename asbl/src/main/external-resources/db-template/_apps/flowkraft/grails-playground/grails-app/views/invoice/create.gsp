    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-plus-circle me-2 text-muted"></i>New Invoice
                    </h5>
                </div>
                <div class="card-body">
                    <g:form action="save" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control ${hasErrors(bean: invoice, field: 'issueDate', 'is-invalid')}" 
                                       name="issueDate" value="${invoice?.issueDate ? new java.text.SimpleDateFormat('yyyy-MM-dd').format(invoice.issueDate) : new java.text.SimpleDateFormat('yyyy-MM-dd').format(new Date())}"/>
                        ...
                        <div class="mb-4">
                            <textarea class="form-control" name="notes" rows="3" placeholder="Optional notes for the customer...">${invoice?.notes}</textarea>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-calculator me-2 text-muted"></i>Totals Preview
                    </h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless table-sm mb-0">
                        ...
                        <tr class="border-top">
                            ...
                            <td class="text-end fw-bold text-success" id="previewTotal">$0.00</td>
                        </tr>
                    </table>
                </div>
            </div>
