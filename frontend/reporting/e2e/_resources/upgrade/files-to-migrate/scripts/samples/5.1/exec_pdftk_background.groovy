 ...
 * 		
 *      1.1 - As a sample script to call an external executable during the report bursting
 *      life cycle.
 ...
 *    (compiled to Native code using GCJ), capable of splitting, merging, encrypting,
...
def execOptions =  "\"$extractFilePath\" background samples/stamp.pdf output \"$stampedFilePath\""
