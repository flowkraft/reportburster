...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="siteHref" select="'http://www.pdfburst.com'"/>
  <xsl:param name="docHref" select="'http://www.pdfburst.com/docs'"/>
  <xsl:param name="siteLinkText" select="'pdfburst.com'"/>
...
them using CSS so that they all appear in a column on the right. -->
  ...
  <xsl:param name="html.stylesheet" select="'css/skrf.css'"/>
...
<script type="text/javascript" src="css/shCore.js"><xsl:comment></xsl:comment></script>
 
<!--
    At least one brush, here we choose JS. You need to include a brush for every
    language you want to highlight
-->
<script type="text/javascript" src="css/shBrushJava.js"><xsl:comment></xsl:comment></script>
<script type="text/javascript" src="css/shBrushGroovy.js"><xsl:comment></xsl:comment></script>
...
<script type="text/javascript">
  ...
  <xsl:template match="programlisting">
    ...
    <xsl:variable name="language">
      <xsl:value-of select="string(@htmllanguage)" xmlns:s="java:java.lang.String"/>
    </xsl:variable>
    
    <pre class="brush: {$language}; toolbar: false; gutter: false;">
          <xsl:apply-templates/>
    </pre>
