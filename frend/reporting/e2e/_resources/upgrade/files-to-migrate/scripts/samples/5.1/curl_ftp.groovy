...
/*
 *		By default the script is extracting the required FTP session information
 ...
 *			means "header data"	sent by curl, '<' means "header data" received by curl
 *			that is hidden in normal cases,	and a line starting with '*' means
