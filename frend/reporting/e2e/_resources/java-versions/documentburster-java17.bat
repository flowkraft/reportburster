...
"C:/Program Files/OpenJDK/jdk-17.0.1/bin/java.exe" -DDOCUMENTBURSTER_HOME="%CD%" -cp lib/burst/ant-launcher.jar org.apache.tools.ant.launch.Launcher -buildfile config/_internal/documentburster.xml !javaArgs! -emacs > logs/datapallas.bat.log