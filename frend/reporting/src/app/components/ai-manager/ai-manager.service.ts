...
The generated PlantUML script should contain only the PlantUML syntax necessary for the diagram definition and must exclude all explanatory comments.`,
    ...
    {
      id: 'CUSTOM_DB_SEED_SCRIPT',
      title: 'Write a Custom Database Seed Script',
      description: 'Generate a Groovy script that creates custom tables and populates them with sample data alongside the existing Northwind schema',
      promptText: `Write a Groovy database seed script for [VENDOR] that creates custom tables and populates them with realistic sample data.
...
Please generate a complete, working Groovy script for [VENDOR] with realistic business-domain tables and sample data using DataFaker and groovy.sql.Sql (dbSql).`,
      tags: ['database', 'groovy', 'seed', 'custom-schema'],
      category: 'Database Schema',
    },
    // --- Email Templates ---
    {
