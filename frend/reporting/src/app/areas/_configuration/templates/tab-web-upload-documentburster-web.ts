export const tabWebUploadDocumentBursterWebTemplate = `<ng-template #tabWebUploadDocumentBursterWebTemplate>
  <div class="well">
    ...
    <div class="row">
      ...
      <div class="col-xs-7">
        <a href="https://www.reportburster.com/docs/document-portal/payments" target="_blank">
          <span>https://www.reportburster.com/docs/document-portal/payments</span>
        </a>
        <br>
        <br>
        <a href="https://www.reportburster.com/docs/document-portal/payments" target="_blank">1. Web + DocumentBurster = Customer Payment
          Portal</a>
        <br>
        <a href="https://www.reportburster.com/docs/document-portal/payments" target="_blank">2. Web + DocumentBurster = Invoices2People</a>
        <br>
        ...
        <a href="https://www.reportburster.com/docs/document-portal/payments" target="_blank">5. Web + DocumentBurster =
          Statements2People</a>
        <br>
        <a href="https://www.reportburster.com/docs/document-portal/payments" target="_blank">6. Web + DocumentBurster = Payslips2People</a>
        <br>
        ...
        <br>
        <a href="https://www.reportburster.com/docs/document-portal/payments" target="_blank">8. Web + DocumentBurster = Contracts2People</a>
        <br>
    ...
    <div class="row">
      ...
      <div class="col-xs-3">
        <a href="https://www.reportburster.com/docs/document-portal/quickstart" target="_blank">
